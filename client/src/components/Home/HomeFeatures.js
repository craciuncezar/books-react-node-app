                ...
                <div className="col-md-6 col-xl-3">
                    <div className="card text-center">
                        ...
                        <div className="card-body">
                            <p className="card-text">Keep your reading list organized in one spot.</p>
                        </div>
                    </div>
                </div>
                <div className="col-md-6 col-xl-3">
                    <div className="card text-center">
                        ...
                        <div className="card-body">
                            <p className="card-text">Discover bestsellers and awarded books.</p>
                        </div>
                    </div>
                </div>
                <div className="col-md-6 col-xl-3">
                    <div className="card text-center">
                        ...
                        <div className="card-body">
                            <p className="card-text">Recomandations based on your reading list books.</p>
                        </div>
                    </div>
                </div>
                <div className="col-md-6 col-xl-3">
                    <div className="card text-center">
                        ...
                        <div className="card-body">
                            <p className="card-text">See others reviews and decide what to read next.</p>
                        </div>
                    </div>
                </div>
            </div>
